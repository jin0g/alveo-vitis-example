...
int main(int argc, char** argv) {
    ...
    try {
        ...
        auto bo_a = xrt::bo(device, source_a.data(), DATA_SIZE * sizeof(char), kernel.group_id(0));
        auto bo_b = xrt::bo(device, source_b.data(), DATA_SIZE * sizeof(char), kernel.group_id(1));
